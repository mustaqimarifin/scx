...
import { Loading, Button, Typography, IconAlertCircle } from 'lucide-react  ';
      ...
      {queries.comments.data && (
        ...
        >
          <div className="space-y-1">
            {queries.comments.data.map(
              (comment: { id: React.Key | null | undefined }) => (
              ...
              <Editor
                ...
                actions={
                  <Button
                    onClick={() => {
                      runIfAuthenticated(() => {
                        return mutations.addComment.mutate({
                          topic,
                          parentId,
